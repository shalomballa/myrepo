...
<div class="login-box">
  ...
  <div class="card card-outline card-success">
    <div class="card-header text-center">
      <a href="" class="h1">Inscription</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg"></p>

      <form method="post" action="{{ action('App\Http\Controllers\SignupController@store') }}">
        {{ csrf_field() }}
