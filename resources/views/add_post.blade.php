...
<head>
  ...
  <title>API Social | create post</title>
...
<a href="{{ route('index') }}">voir les posts</a>
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-success">
    <div class="card-header text-center">
      <a href="" class="h1">Créer un post</a>
    </div>
    <div class="card-body">
      ...
      <form method="post" action="{{ action('App\Http\Controllers\PostController@store') }}">
        ...
        <div class="input-group mb-3">
          <label>Contenu</label>
          <textarea name="content" class="form-control" placeholder="pas plus de 250 caractères" required>
